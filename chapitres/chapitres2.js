...
const ennemis = [
  { name: "Orc1", hp: 40, maxHp: 40, attack: 6, xpReward: 15, sprite: "Orc_Idle.png" },
  { name: "Orc2", hp: 50, maxHp: 50, attack: 8, xpReward: 20, sprite: "Orc_Idle.png" },
  { name: "Orc3", hp: 60, maxHp: 60, attack: 10, xpReward: 25, sprite: "Orc_Idle.png" },
  { name: "Orc Mutant", hp: 120, maxHp: 120, attack: 14, xpReward: 60, sprite: "Enemy3No-Move-Idle.png" }
];
      ...
      if (currentEnemy.hp <= 0) {
        ...
        setTimeout(function () {
          ...
          if (currentEnemyIndex >= ennemis.length) {
            attackBtn.disabled = true;
            localStorage.setItem("chapitre3", "unlocked");
